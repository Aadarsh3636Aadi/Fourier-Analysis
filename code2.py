...
t3=linspace(pi,3*pi,65);t3=t3[:-1]                          #y=sin(sqrt(2)*t)
figure(2)
...
omega_no_noise,delta_no_noise = w_delta(y)
...
omega_noise,delta_noise = w_delta(y_noise)
